...
public class RequestServiceImpl implements RequestService {
    ...
    public List<ItemRequestDto> getRequests(Long id) {
        return toListRequestDto(requestRepository.findByRequestor(id))
                .stream()
                .peek(this::setItems)
                .toList();
    }
    ...
    public List<ItemRequestDto> getAllRequests() {
        return toListRequestDto(requestRepository.findAll())
                .stream()
                .peek(this::setItems)
                .toList();
    }
    ...
    private ItemRequestDto setItems(ItemRequestDto request) {
        request.setItems(itemService.searchItemsByRequest(request.getId()));
        return request;
    }
